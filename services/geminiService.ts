...
export const generateToDoList = async (
  ...
  const prompt = `
    ...
    Each task object in the JSON array must have four properties: "plantName", "task" (a short action, e.g., "Water"), "reason" (a brief explanation), and "timing" (a string: "Overdue", "Today", or "This Week").
  ...
  const responseSchema = {
    ...
    items: {
      ...
      required: ['plantName', 'task', 'reason', 'timing'],
    },
  };
